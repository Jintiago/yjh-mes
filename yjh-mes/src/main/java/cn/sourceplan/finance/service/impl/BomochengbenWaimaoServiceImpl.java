...
import cn.sourceplan.finance.mapper.BomochengbenWaimaoMapper;
 ...
 */
@Service
public class BomochengbenWaimaoServiceImpl implements IBomochengbenWaimaoService
{
    @Autowired
    private BomochengbenWaimaoMapper bomochengbenMapper;
    ...
    {
        QueryWrapper<BomochengbenWaimao> qw = new QueryWrapper<>(bomochengben);
    ...
    BomochengbenWaimao chengbenjisuan(BomochengbenWaimao domain){
        ...
        if("公斤价".equals(priceType)){
            ...
            BigDecimal jizhunjia = NumberUtil.div(domain.getChengben(), 0.81);
        ...
        if("平方价".equals(priceType)){
            ...
            BigDecimal jizhunjia = NumberUtil.div(chengben, 0.81);
            domain.setJizhunjia(jizhunjia);
            domain.setJizhunjiaB(NumberUtil.mul(jizhunjia,0.93));
