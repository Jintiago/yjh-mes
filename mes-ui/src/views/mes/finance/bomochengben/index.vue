...
<!--      <el-table-column label="印刷" align="center" prop="yinshua" width="120" />-->
      ...
      <el-table-column label="外贸基准价" align="center" prop="jizhunjiaWaimao" width="120"/>
      <el-table-column label="外贸不含税基准价" align="center" prop="jizhunjiaWaimaoB" width="140"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="980px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="胶水" prop="jiaoshuiType">
              <el-select v-model="form.jiaoshuiType"    >
                <el-option
                  v-for="item in jiaoshuiTypeList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
          ...
          <el-col :span="6">
            <el-form-item label="功能性" prop="gongneng" >
              <el-input v-model="form.gongneng" placeholder="" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="6">
            <el-form-item label="纸管" prop="zhiguanP">
              <el-select v-model="form.zhiguanP"    >
                <el-option
                  v-for="item in zhiguanPList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
          ...
          <el-col :span="6">
            <el-form-item label="包装" prop="baozhuangP">
              <el-select v-model="form.baozhuangP"    >
                <el-option
                  v-for="item in baozhuangPList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
          ...
          <el-col :span="6">
            <el-form-item label="分切" prop="fenqieP">
              <el-select v-model="form.fenqieP"    >
                <el-option
                  v-for="item in fenqiePList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
...
<!--        <el-row>-->
<!--          <el-col :span="8">-->
<!--            <el-form-item label="人工" prop="rengong">-->
<!--              <el-input v-model="form.rengong" placeholder="" :disabled="true"/>-->
<!--            </el-form-item>-->
<!--          </el-col>-->
<!--          <el-col :span="4">-->
<!--            <el-form-item label="成本" prop="chengben">-->
<!--              <el-input v-model="form.chengben" placeholder="" :disabled="true"/>-->
<!--            </el-form-item>-->
<!--          </el-col>-->
<!--          <el-col :span="4">-->
<!--            <el-form-item label="吹膜速度" prop="chuimosd">-->
<!--              <el-input type="number" v-model="form.chuimosd" placeholder="" :disabled="true"/>-->
<!--            </el-form-item>-->
<!--          </el-col>-->
<!--          <el-col :span="4">-->
<!--            <el-form-item label="原料价格" prop="yuanliaojg" >-->
<!--              <el-input v-model="form.yuanliaojg" placeholder="" :disabled="true"/>-->
<!--            </el-form-item>-->
<!--          </el-col>-->
<!--          <el-col :span="4">-->
<!--            <el-form-item label="胶水价格" prop="jiaoshuijg" >-->
<!--              <el-input v-model="form.jiaoshuijg" placeholder="" :disabled="true"/>-->
<!--            </el-form-item>-->
<!--          </el-col>-->
<!--        </el-row>-->
        <el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="外贸含税基准价" prop="jizhunjiaWaimao" label-width="150px">
              <el-input v-model="form.jizhunjiaWaimao" placeholder="" :disabled="true"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="外贸不含税基准价" prop="jizhunjiaWaimaoB" label-width="150px">
              <el-input v-model="form.jizhunjiaWaimaoB" placeholder="" :disabled="true"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-collapse  >
...
<script>
import { listBomochengben, getBomochengben, delBomochengben, addBomochengben, updateBomochengben } from "@/api/mes/finance/bomochengben";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listBomochengben(this.queryParams).then(response => {
    ...
    handleUpdate(row) {
      ...
      getBomochengben(id).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          ...
          if (this.form.id != null) {
            updateBomochengben(this.form).then(response => {
              this.$modal.msgSuccess("成本核算成功");
              this.open = false;
              this.getList();
            });
          } else {
            addBomochengben(this.form).then(response => {
