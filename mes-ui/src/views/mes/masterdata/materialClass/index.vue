    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['masterdata:materialClass:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['masterdata:materialClass:edit']"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
          ...
          <el-button
            ...
            v-hasPermi="['masterdata:materialClass:remove']"
          >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="父项id" prop="parentId" >
          <treeselect v-model="form.parentId" :options="materialClassOptions" :normalizer="normalizer" placeholder="请选择父项id" :disabled='disabledFlag'/>
        </el-form-item>
        <el-form-item label="名称" prop="name">
...
<script>
import { listMaterialClass, getMaterialClass, delMaterialClass, addMaterialClass, updateMaterialClass } from "@/api/mes/masterdata/materialClass";
